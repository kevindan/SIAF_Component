...
public class ClasifSaldoPimReq implements Serializable {
	...
	public ClasifSaldoPimReq() {

	}

	public ClasifSaldoPimReq(String ano_eje, String fuente_finac, String sec_ejec, String id_clasifi, String sec_func) {
	...
	public String toString() {
		return "ClasifSaldoPimReq [ano_eje=" + ano_eje + ", fuente_finac=" + fuente_finac + ", sec_ejec=" + sec_ejec
				+ ", id_clasifi=" + id_clasifi + ", sec_func=" + sec_func + "]";
	}
