...
public class IntfDet09 implements Serializable {
	...
	public IntfDet09(String id_clasifi, String clasifniv1, String clasifniv2, String clasifniv3, String clasifniv4,
			String clasifniv5, String clasifniv6, String sec_func, String monto, String monto_mn) {
	...
	public String toString() {
		return "IntfDet09 [id_clasifi=" + id_clasifi + ", clasifniv1=" + clasifniv1 + ", clasifniv2=" + clasifniv2
				+ ", clasifniv3=" + clasifniv3 + ", clasifniv4=" + clasifniv4 + ", clasifniv5=" + clasifniv5
				+ ", clasifniv6=" + clasifniv6 + ", sec_func=" + sec_func + ", monto=" + monto + ", monto_mn="
				+ monto_mn + "]";
	}
