...
public class ClasificadorMontoConsolidadoPim implements Serializable {
	...
	public ClasificadorMontoConsolidadoPim() {

	}

	public ClasificadorMontoConsolidadoPim(String ano_eje, Integer periodo_mensual, String sec_func,
			String fuente_financ, String id_clasificador, BigDecimal pia, BigDecimal pim) {
	...
	public String toString() {
		return "ClasificadorMontoConsolidadoPim [ano_eje=" + ano_eje + ", periodo_mensual=" + periodo_mensual
