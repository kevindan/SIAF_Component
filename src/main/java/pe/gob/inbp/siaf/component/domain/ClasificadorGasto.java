...
public class ClasificadorGasto implements Serializable {
	...
	public ClasificadorGasto(String id_clasificador_gasto, String ano_eje, String tipo_transaccion,
			String tipo_transaccion_nombre, String generica, String generica_nombre, String subgenerica,
			String subgenerica_nombre, String subgenerica_det, String subgenerica_det_nombre, String especifica,
			String especifica_nombre, String especifica_det, String id_clasificador, String nombre_clasificador) {
	...
	public String toString() {
		return "ClasificadorGasto [id_clasificador_gasto=" + id_clasificador_gasto + ", ano_eje=" + ano_eje
				...
				+ ", id_clasificador=" + id_clasificador + ", nombre_clasificador=" + nombre_clasificador + "]";
	}
